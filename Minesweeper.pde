...
public class MSButton
{
    ...
    {
        int numBombs = 0;
        if (isValid(row, col-1) && buttons[r][c-1].isMarked())
       ...
       if (isValid(row,col+1)&& buttons[r][c+1].isMarked())
        ...
        if (isValid(row-1,col)&& buttons[r-1][c].isMarked())
           numBombs++;
      
       if (isValid(row+1,col)&& buttons[r+1][c].isMarked())
           numBombs++;
           
       if (isValid(row+1,col+1)&& buttons[r+1][c+1].isMarked())
           numBombs++;
       
       if (isValid(row-1,col-1)&& buttons[r+1][c].isMarked())
           numBombs++;
